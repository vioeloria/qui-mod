...
-- Tracked in the UI timezone; date is stored as 'YYYY-MM-DD'.
CREATE TABLE IF NOT EXISTS instance_daily_traffic (
    ...
    peak_ul_speed BIGINT NOT NULL DEFAULT 0,
    peak_dl_speed BIGINT NOT NULL DEFAULT 0,
...
ALTER TABLE instances ADD COLUMN daily_traffic_enabled BOOLEAN NOT NULL DEFAULT TRUE;
